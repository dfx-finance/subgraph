...
export class Curve__curveResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class Curve__depositResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class Curve__depositWithWhitelistResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class Curve__liquidityResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class Curve__viewCurveResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class Curve__viewDepositResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class Curve extends ethereum.SmartContract {
  ...
  try_curve(): ethereum.CallResult<Curve__curveResult> {
    let result = super.tryCall(
      "curve",
      "curve():(int128,int128,int128,int128,int128,uint256)",
      []
  ...
  deposit(_deposit: BigInt, _deadline: BigInt): Curve__depositResult {
    let result = super.call(
      "deposit",
    ...
    return new Curve__depositResult(
      result[0].toBigInt(),
  ...
  try_deposit(
    _deposit: BigInt,
    _deadline: BigInt
  ): ethereum.CallResult<Curve__depositResult> {
    let result = super.tryCall(
      "deposit",
      "deposit(uint256,uint256):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Curve__depositResult(value[0].toBigInt(), value[1].toBigIntArray())
    );
  }
  ...
  depositWithWhitelist(
    ...
    _deposit: BigInt,
    _deadline: BigInt
  ): Curve__depositWithWhitelistResult {
    let result = super.call(
      "depositWithWhitelist",
    ...
    return new Curve__depositWithWhitelistResult(
      result[0].toBigInt(),
      result[1].toBigIntArray()
    );
  }
  ...
  try_depositWithWhitelist(
    ...
    _deposit: BigInt,
    _deadline: BigInt
  ): ethereum.CallResult<Curve__depositWithWhitelistResult> {
    let result = super.tryCall(
      "depositWithWhitelist",
      "depositWithWhitelist(uint256,address,uint256,bytes32[],uint256,uint256):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Curve__depositWithWhitelistResult(
        value[0].toBigInt(),
  ...
  liquidity(): Curve__liquidityResult {
    let result = super.call("liquidity", "liquidity():(uint256,uint256[])", []);

    return new Curve__liquidityResult(
      result[0].toBigInt(),
      result[1].toBigIntArray()
    );
  }

  try_liquidity(): ethereum.CallResult<Curve__liquidityResult> {
    let result = super.tryCall(
      "liquidity",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Curve__liquidityResult(value[0].toBigInt(), value[1].toBigIntArray())
    );
  }
  ...
  viewCurve(): Curve__viewCurveResult {
    let result = super.call(
      "viewCurve",
    ...
    return new Curve__viewCurveResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_viewCurve(): ethereum.CallResult<Curve__viewCurveResult> {
    let result = super.tryCall(
      "viewCurve",
      "viewCurve():(uint256,uint256,uint256,uint256,uint256)",
      []
  ...
  viewDeposit(_deposit: BigInt): Curve__viewDepositResult {
    let result = super.call(
      "viewDeposit",
    ...
    return new Curve__viewDepositResult(
      result[0].toBigInt(),
      result[1].toBigIntArray()
    );
  }
  ...
  try_viewDeposit(
    _deposit: BigInt
  ): ethereum.CallResult<Curve__viewDepositResult> {
    let result = super.tryCall(
      "viewDeposit",
      "viewDeposit(uint256):(uint256,uint256[])",
      [ethereum.Value.fromUnsignedBigInt(_deposit)]
