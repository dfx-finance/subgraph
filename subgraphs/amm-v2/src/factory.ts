...
import { USDC } from "../../../packages/constants/index";
...
export function handleCurveFactoryOwnershipTransferred(
  event: CurveFactoryOwnershipTransferredEvent
): void {}
...
export function handleAssimOwnershipTransferred(
  event: AssimOwnershipTransferredEvent
): void {}
